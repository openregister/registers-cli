...
def init(filepath):
    ...
    assert_root_hash = "assert-root-hash\t{}".format(EMPTY_ROOT_HASH)
    ...
    click.echo("Empty register successfully created at {}"
               .format(click.style(click.format_filename(filepath),
                                   fg='bright_yellow')))
